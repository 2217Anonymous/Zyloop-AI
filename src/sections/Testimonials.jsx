            ...
            <Row className="category-section-row">
              ...
              >
                <div className="testimonial-details wow fadeInLeft">
                  ...
                  <h4 className="heading">
                    AI FOR EVERY <span>FUNCTION</span>
                  </h4>
                  <p className="text">
              ...
              <Col span={12} lg={8}>
                ...
                >
                  ...
                  <button
                    type="button"
                    className="content-carousel-nav content-carousel-prev category-split-nav"
                  ...
                  <button
                    type="button"
                    className="content-carousel-nav content-carousel-next category-split-nav"
                  ...
                  <div className="category-split-controls">
                    <div className="category-split-dots" role="tablist" aria-label="Business categories">
